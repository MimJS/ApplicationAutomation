...
async function tick() {
  ...
  // Energy=10 но бустер недоступен → играем 1, иначе рег +1/10мин пропадает
  if (currentEnergy >= MAX_ENERGY) {
    tg(
      `⚡ Энергия=10, но бустер недоступен — играю 1! 🎮\n` +
        `🔄 Рег вернёт до 10 за 10мин. Не теряем ни рег, ни очки.`,
    );
